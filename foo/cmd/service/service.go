...
import (
	...
	http "github.com/burxtx/fault/foo/pkg/http"
...
var fs = flag.NewFlagSet("foo", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "foo")
