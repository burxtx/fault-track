...
import (
	...
	http "github.com/burxtx/fault/fault/pkg/http"
...
var fs = flag.NewFlagSet("fault", flag.ExitOnError)
...
func Run(db *xorm.Engine) {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "fault")
	...
	svc := service.New(db, getServiceMiddleware(logger))
